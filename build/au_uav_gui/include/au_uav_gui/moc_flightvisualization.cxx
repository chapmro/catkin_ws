...
**
** Created: Tue May 17 18:18:11 2016
**      by: The Qt Meta Object Compiler version 63 (Qt 4.8.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../../../../src/au_uav_gui/include/au_uav_gui/flightvisualization.hpp"
...
static const char qt_meta_stringdata_FlightVisualization[] = {
    ...
    "resetFlightPaths()\0latitude,longitude\0"
    "setMapCenter(double,double)\0"
    ...
    "comboIndex\0setCurrentPlane(int)\0"
    "showPlaneSelector()\0item\0"
    "togglePlaneVisibility(QListWidgetItem*)\0"
};
...
void FlightVisualization::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->resetFlightPaths(); break;
        case 4: _t->setMapCenter((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        case 5: _t->updateMarker((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        case 6: _t->updateFlightPath((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 7: _t->toggleFlightPath((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 8: _t->toggleWayPoints((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 9: _t->toggleAutoCenter((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 10: _t->toggleAutoFit((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 11: _t->setWayPoint((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 12: _t->adjustMapCenter(); break;
        case 13: _t->loadFinished((*reinterpret_cast< bool(*)>(_a[1]))); break;
